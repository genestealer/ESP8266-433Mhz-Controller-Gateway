...
//PubSubClient setBufferSize(512); //DO TO, libary does not yet have this. https://github.com/knolleary/pubsubclient/commit/5b23a97fb00f73c8f8bd4a0bcee9576ae62c8d5c
// https://github.com/knolleary/pubsubclient/issues/110
// https://github.com/knolleary/pubsubclient/pull/282

char message_buff[100]; //was 100
...
boolean mqttReconnect() {
  ...
  if (mqttClient.connect(clientName, mqtt_username, mqtt_password, publishLastWillTopic, 0, willRetain, willMessage)) {
    ...
    mqttClient.publish(MQTT_SENSOR_TOPIC, buffer, true);
  }
  else
  {
